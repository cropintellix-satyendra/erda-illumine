              ...
              <!-- pipe image -->
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        {{--p>Oboarding plot area:. <span id="onboarding_plot_area">10.2</span></p>
                        <p>Google plot area:. <span id="google_plot_area">3.2</span></p>
                        <p>Updated aplot rea:. <span id="update_plot_area">2.3</span></p>--}}
                    </div>
                </div>
            ...
            if (str_coordinates_poly !== null) {
                    ...
                    Swal.fire({
                            ...
                            if (result.value == 1) {
                                      $.ajax({
                                        type:"post",
                                        url:"{{ url('l2/pipe/polygon/update')}}/" + farmer_plot_uniqueid,
