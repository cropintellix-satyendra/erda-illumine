                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tbody id="Basicform">
                                        ...
                                        <tr>
                                            <td>Farmer Name</td>
                                            <td><input type="text" class="form-control" name="farmer_name" style="" value="{{$plot->farmer_name}}" readonly></td>
                                        </tr>
                                        <tr>
                                            <td>Mobile Access</td>
                                            <td>
                                                <select id="mobile_access" name="mobile_access" class="form-control select2" disabled>
                                                    ...
                                                    <option value="Own Number" {{ 'Own Number' == $plot->mobile_access ? 'Selected' :'' }}>Own Number</option>
                                                    <option value="Relatives Number" {{ 'Relatives Number' == $plot->mobile_access ? 'Selected' :'' }}>Relatives Number</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" name="aadhaar" style="" value="{{$plot->aadhaar??'NA'}}" readonly></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <select id="mobile_reln_owner" name="mobile_reln_owner" class="form-control select2" disabled>
                                                    ...
                                                    <option value="{{$relationshipowner->name}}" {{ $relationshipowner->name == $plot->mobile_reln_owner ? 'Selected' :'' }}>{{$relationshipowner->name}}</option>
                                                    @endforeach
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Mobile</td>
                                            <td><input type="text" class="form-control" name="mobile" value="{{$plot->mobile}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" readonly maxlength="10"></td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tbody id="EditPlot">
                                        <tr>
                                            <td>No of Plots</td>
                                            <td colspan="3">{{$plot->no_of_plots??"NA"}}</td>
                                            <td>Area of Plots</td>
                                            <td>{{$plot->total_plot_area??"NA"}}</td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" style="width: 70px;" class="form-control area_in_acers" id="area_in_acers{{$plot->plot_no}}" name="area_in_acers" data-plot="{{$plot->plot_no}}" value="{{$plot->area_in_acers}}" readonly oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                                <br><span class='d-none'id='area_in_acersreq{{$plot->plot_no}}' style="color:red;">Required </span><br><span class='d-none' id="area_acers_base{{$plot->plot_no}}" style="color:red;"> Should be greater than{{$minimumvalues->value}}
                                                </span>
                                            </td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-sm">
                                            <tbody>
                                                <tr>
                                                    <td>Plot Id</td>
                                                    <td>{{$plot->final_farmers->farmer_plot_uniqueid}}</td>
                                                    {{-- {{dd($Croplot->farmer_plot_uniqueid)}} --}}
                                                </tr>
                                                <tr>
                                                    <td>Total Area In Bigha</td>
                                                    <td>{{$plot->final_farmers->ApprvFarmerPlot->area_in_other??'-'}}</td>
                                                </tr>
                                                <tr>
                                                    <td>Total Area In Acres</td>
                                                    <td>{{$plot->final_farmers->area_in_acers??'-'}}</td>
                                                </tr>
                                                <tr>
                                                    <td>Own Area in Bigha</td>
                                                    <td>{{$plot->final_farmers->own_area_in_acres*3.025
                                                        ??'-'}}</td>
                                                </tr>
                                                <tr>
                                                    <td>Own Area in Acres</td>
                                                    <td>{{$plot->final_farmers->own_area_in_acres??'-'}}</td>
                                                </tr>
                                                <tr>
                                                    <td>Lease Area in Bigha</td>
                                                    <td>{{$plot->final_farmers->lease_area_in_acres*3.025??'-'}}</td>
                                                </tr>
                                                <tr>
                                                    <td>Lease Area in Acres</td>
                                                    <td>{{$plot->final_farmers->lease_area_in_acres??'-'}}</td>
                                                </tr>
                                                <tr>
                                                    <td>Area Chosen For AWD(Bigha)</td>
                                                    <td>{{$plot->final_farmers->ApprvFarmerPlot->area_other_awd??'-'}}</td>
                                                </tr>
                                                <tr>
                                                    <td>Area Chosen For AWD(Acres)</td>
                                                    <td>{{$plot->final_farmers->ApprvFarmerPlot->area_acre_awd??'-'}}</td>
                                                </tr>
                                                {{-- {{dd($plot->plot_area??"0")}} --}}
                                                <tr>
                                                    <td>Plot Area (AWD Area in Bigha )</td>
                                                    <td>{{$plot->final_farmers->plot_area*3.025??'-'}}</td> 
                                                </tr>
                                                <tr>
                                                    <td>Plot Area (AWD Area in Acre)</td>
                                                    <td>{{$plot->final_farmers->plot_area??'-'}}</td>
                                                </tr>
                                                <tr>
                                                    <td>Owner Name</td>
                                                    <td>{{$plot->final_farmers->farmer_name??'-'}}</td>
                                                </tr>
                                                @if ($plot->final_farmers->state_id == 29)
                                                <tr>
                                                    <td>Patta Number</td>
                                                    <td>{{$plot->final_farmers->ApprvFarmerPlot->patta_number??'NA'}}</td>
                                                </tr>
                                                <tr>
                                                    <td>Daag Number</td>
                                                    <td>{{$plot->final_farmers->ApprvFarmerPlot->daag_number??'NA'}}</td>
                                                </tr>
                                                @endif
                                                @if ($plot->final_farmers->state_id == 37)
                                                <tr>
                                                    <td>Khatian Number</td>
                                                    <td>{{$plot->final_farmers->khatian_number??'NA'}}</td>
                                                </tr>
                                                @endif
                                                ...
                                                <tr style="line-height: 0;">
                                                    ...
                                                    <td>
                                                        <div class="plot-gallery d-flex">
                                                            ...
                                                            @if($plot->final_farmers->ApprvFarmerPlotImages)

                                                                @forelse($plot->final_farmers->ApprvFarmerPlotImages()->get() as $items)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-sm" href="{{url('admin/farmers/download/'.$plot->final_farmers->farmer_plot_uniqueid.'/'.'LEASED'.'/'.$plot->final_farmers->plot_no)}}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn text-success btn-sm" href="{{url('l2/download/file/'.'Individuals/'.$plot->final_farmers->farmer_uniqueId.'/'.$plot->final_farmers->plot_no.'/'.'Approved')}}">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tbody id="EditLocation">
                                        <tr>
                                              <td>State</td>
                                            {{-- {{dd($plot->final_farmers)}} --}}
                                              <td>{{$plot->final_farmers->state->name}}</td>
                                            </tr>
                                            <tr>
                                              <td>District</td>
                                              <td>{{$plot->final_farmers->district->district}}</td>
                                            </tr>
                                            <tr>
                                              <td>Taluka</td>
                                              <td>{{$plot->final_farmers->taluka->taluka}}</td>
                                            </tr>
                                        <tr>
                                            <td>Panchayat</td>
                                            <td>
                                                ...
                                                {{-- <select id="panchayats" name="panchayats" onchange="FetchVillage(this.value)" 
                                                class="form-control select2" disabled>
                                                    <option value="">Panchayat</option>
                                                    @if($panchayats)
                                                    @foreach($panchayats as $panchayat)
                                                    <option value="{!! $panchayat->id !!}" {{ $plot->final_farmers->panchayat_id == $panchayat->id ?'Selected' :'' }}>{!! $panchayat->panchayat !!}</option>
                                                    @endforeach
                                                    @endif
                                                </select> --}}
                                                ...
                                                <select id="panchayats" name="panchayats" onchange="FetchVillage(this.value)" class="form-control select2" disabled>
                                                    <option value="">Panchayat</option>
                                                    @if($panchayats)
                                                        @foreach($panchayats->chunk(10) as $chunk)
                                                            @foreach($chunk as $panchayat)
                                                                <option value="{!! $panchayat->id !!}" {{ $plot->final_farmers->panchayat_id == $panchayat->id ? 'selected' : '' }}>
                                                                    {!! $panchayat->panchayat !!}
                                                                </option>
                                                            @endforeach
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select id="villages" name="villages" class="form-control select2" disabled>
                                                    ...
                                                    @if($villages)
                                                        @foreach($villages->chunk(10) as $chunk)
                                                            @foreach($chunk as $village)
                                                                <option value="{!! $village->id !!}" {{ $plot->final_farmers->village_id == $village->id ? 'selected' : '' }}>
                                                                    {!! $village->village !!}
                                                                </option>
                                                            @endforeach
                                                            <option disabled>--------------------------</option>
                                        ...
                                        <tr>
                                            <td>Remarks</td>
                                            <td>{{$plot->final_farmers->remarks}}</td>
                                        </tr>
                                        <tr>
                                            <td>Latitude</td>
                                            <td>{{$plot->final_farmers->latitude}}</td>
                                        </tr>
                                        <tr>
                                            <td>Logitude</td>
                                            <td>{{$plot->final_farmers->longitude}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Name</td>
                                            <td><a target="_blank" href="">{{$plot->final_farmers->surveyor_name}}</a></td>
                                        </tr>
                                        <tr>
                                            <td>Mobile No</td>
                                            <td>{{$plot->final_farmers->surveyor_mobile}}</td>
                                        </tr>
                                        <tr>
                                            <td>Date of Survey</td>
                                            <td>{{$plot->final_farmers->date_survey}}</td>
                                        </tr>
                                        <tr>
                                            <td>Time of Survey</td>
                                            <td>{{ $plot->final_farmers->time_survey }} </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                ...
                <div class="col-12">
                    <div class="card" style="margin-right: -24px;margin-left: -24px;">
                        <div class="card-body" style="padding-left: 23px;padding-top: 11px;padding-right: 2px;">
                            ...
                            <div class="mb-1">
                                <div class="row mb-3">
                                    <a style="width: 30%;" class="active btn btn-status{{$plot->onboarding_form ? '-done' : ''}} m-b-0 mr-3"><span class="btn-txt">Farmer Onboarding</span></a>
                                    <a style="width: 26%;" class="CropDataShow btn btn-status{{$plot->cropdata_form ? '-done' : ''}} m-b-0 mr-3"><span class="btn-txt">Crop data</span></a>
                                    <a style="width: 31%;" class="btn btn-status{{$plot->pipes_form ? '-done' : ''}} m-b-0 mr-3"><span class="btn-txt">Pipes Installations</span></a>
                                </div>
                                <div class="row mb-3">
                                    <a style="width: 30%;" class="btn btn-status{{$plot->awd_form ? '-done' : ''}} m-b-0 mr-3"><span class="btn-txt">AWD Captured</span></a>
                                    <a style="width: 26%;" class="FarmerBenefits btn btn-status{{$plot->benefit_form ? '-done' : ''}} m-b-0 mr-3"><span class="btn-txt">Benefits</span></a>
                                    <a style="width: 30%;" class="btn btn-status{{$plot->other_form ? '-done' : ''}} m-b-0"><span class="btn-txt">Others</span></a>
                                </div>
                                <div class="row">
                                    <a style="width: 30%;" href="{{url('l2/pending/plot/detail').'/'.$plot->id.'/'.$plot->farmer_plot_uniqueid}}" class="btn btn-info m-b-0 mr-3 EditBtn"
                                        >Show</a>
                                    <!-- end button end -->
                                    {{-- onclick="submitApprove('{{$plot->farmer_uniqueId}}')" --}}
                                    <button style="width: 26%;" data-toggle="modal" data-target="#ApproveModal" class="btn btn-success ApproveBtn m-b-0 mr-3 d-none" {{-- below code is to disable button if --}} 

                                    {{-- {{dd($plot)}} --}}
                                    @if(Auth::user()->hasRole('L-2-Validator'))
                                        disabled
                                        @endif
                                        @if($plot->final_status == 'Approved')

                                        @elseif($plot->final_status == 'Rejected')
                                    ...
                                    <!-- approve end -->
                                    <button style="width: 30%;" data-toggle="modal" data-target="#reject_remark" class="btn btn-danger RejectBtn m-b-0 mr-3 d-none" @if(Auth::user()->hasRole('L-1-Validator'))
                                        disabled
                                        @endif
                                        @if($plot->final_status == 'Approved')
                                        disabled
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="{{ $plot->onboarding_form ? 'Form-Done' : '' }}"><a class="active btn btn-status{{$plot->status_onboarding ? '-done' : ''}} m-b-0 mr-3"><span class="btn-txt">Farmer Onboarding</span></a></td>
                    <td class="{{ $plot->cropdata_form ? 'Form-Done' : '' }}">Crop Data</td>
                    </tr>
                    <tr>
                        <td colspan="2"></td>
                    </tr>
                    <tr>
                        <td class="{{ $plot->pipes_form ? 'Form-Done' : '' }}">Pipes Installations</td>
                        <td class="{{ $plot->awd_form ? 'Form-Done' : '' }}">AWD Events Captured</td>
                    </tr>
                    <tr>
                        <td colspan="2"></td>
                    </tr>
                    <tr>
                        <td class="{{ $plot->benefit_form ? 'Form-Done' : '' }}">Farmer Benefits</td>
                        <td class="{{ $plot->other_form ? 'Form-Done' : '' }}">Reports</td>
                    </tr>
                    <tr>
                        <td colspan="2"></td>
                    </tr>
        ...
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title bg-primary text-white p-3 text-center">Farmer photo</h5>
                          
                            {{-- {{dd($plot->where('))}} --}}
                            @php
                                $farmer_image = App\Models\FinalFarmer::where('farmer_uniqueId',$plot->farmer_uniqueId)->get();
                                // dd($farmer_image);
                            @endphp
                              @foreach($farmer_image as $items)
                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                      
                                      <div class="carousel-item active">
                                        <img class="d-block w-100" src="{{$items->farmer_photo}}" alt="">
                                      </div>
                                      <div class="carousel-item">
                                        <img class="d-block w-100" src="{{$items->aadhaar_photo}}" alt="">
                                      </div>
                                      <div class="carousel-item">
                                        <img class="d-block w-100" src="{{$items->others_photo}}" alt="">
                                      </div>
                                    </div>
                ...
                @if($plot->final_farmers->ApprvFarmerPlotImages()->count()>0)
               {{-- {{dd($plot->plot_no)}}  --}}
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title bg-primary text-white p-3 text-center">Plot Photo</h5>
                            <!-- All plot images -->
                            <div id="PlotImg" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    @foreach($plot->final_farmers->ApprvFarmerPlotImages()->where('plot_no',$plot->final_farmers->plot_no)->get() as $items)
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-sm">
                        ...
                        <tbody>
                            <tr>
                                <td>Remark</td>
                                <td>{{$plot->reject_remark}}</td>
                            </tr>
                            <tr>
                                <td>Remark Date/Time</td>
                                <td>{{$plot->reject_timestamp}}</td>
                            </tr>
...
<script>
    $(document).ready(function() {
        // Initialize Select2
        $('#panchayats').select2({
            placeholder: 'Select or search for Panchayat...',
            allowClear: true,
        });

        // Search functionality
        $('#searchPanchayat').on('input', function () {
            var searchTerm = $(this).val().toLowerCase();
            $('#panchayats option').each(function () {
                var textToMatch = $(this).text().toLowerCase();
                $(this).toggle(textToMatch.includes(searchTerm));
            });
        });

        // Optional: Set a placeholder for the search input
        $('#panchayats').on('select2:open', function () {
            $('.select2-search__field').attr('placeholder', 'Search Panchayat...');
        });
    });
</script>
<script>
    $(document).ready(function() {
        // Initialize Select2
        $('#villages').select2({
            placeholder: 'Select or search for Village...',
            allowClear: true,
        });

        // Search functionality
        $('#searchVillage').on('input', function () {
            var searchTerm = $(this).val().toLowerCase();
        ...
        // Optional: Set a placeholder for the search input
        $('#villages').on('select2:open', function () {
            $('.select2-search__field').attr('placeholder', 'Search Village...');
        });
    });
</script>
...
<script>
    ...
    $('.UpdateBasicform').click(function() {
        ...
        $.ajax({
            type: 'post',
            url: "{{url('l2/update')}}/" + '{{$plot->farmer_uniqueId}}',
            data: {
                _token: '{{csrf_token()}}',
                method: 'post',
                ...
                aadhaar: $('input[name=aadhaar]').val(),
