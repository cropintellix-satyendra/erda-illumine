                                        ...
                                        @foreach($plots_paginate as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($value->l2status == 'Rejected')
                                                     <a class="btn text-danger" href="{{ url('l2/rejected/pipeinstallation/plot')}}/{{$value->farmer_plot_uniqueid}}" title="Show"> {{ $value->plot_no }}</a>
...
$(function(){
    ...
    //                     status_color='text-danger';
    //                 }
    //                 return '<a class="btn '+status_color+'" href="{{ url('l2/rejected/pipeinstallation/plot')}}/'+row.farmer_plot_uniqueid+'" title="Show">'+data+'</a>';
    //             },
    //             "targets": 2,
    //         },
    //         {render: function (data, type, row, meta) {
