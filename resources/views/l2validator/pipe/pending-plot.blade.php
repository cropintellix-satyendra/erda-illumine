                                        ...
                                        @foreach($plots_paginate as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($value->l2status == 'Pending')
                                                     <a class="btn text-info" href="{{ url('l2/pending/pipeinstallation/plot')}}/{{$value->farmer_plot_uniqueid}}" title="Show"> {{ $value->plot_no }}</a>
                                                     @endif                                                   
                                                </td>
...
$(function(){
    ...
    //                 //     status_color='text-danger';
    //                 // }
    //                 return '<a class="btn text-info" href="{{ url('l2/pending/pipeinstallation/plot')}}/'+row.farmer_plot_uniqueid+'" title="Show">'+data+'</a>';
    //             },
    //             "targets": 2,
    //         },
    //         {render: function (data, type, row, meta) {
