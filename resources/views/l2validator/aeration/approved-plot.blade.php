                        ...
                        <table id="example3" class="table table-bordered dt-responsive nowrap display data-table" style="min-width: 845px">
                            ...
                            <tbody>
                                    @if(!empty($plots_paginate) && $plots_paginate->count())
                                        ...
                                        {{-- {{dd($value->farmerapproved->district)}} --}}
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($value->l2_status == 'Approved')
                                                     <a class="btn text-success" href="{{ url('l2/approved/aeration/plot')}}/{{$value->farmer_plot_uniqueid}}/{{$value->aeration_no}}/{{$value->pipe_no}}" title="Show"> {{ $value->plot_no }}</a>                                        
                                                     @endif         
                                                    </td>
                                                <td>{{ $value->pipe_no }}</td>
...
$(function(){
    ...
    //                     status_color='text-danger';
    //                 }
    //                 return '<a class="btn '+status_color+'" href="{{ url('l2/approved/aeration/plot')}}/'+row.farmer_plot_uniqueid+'/'+row.aeration_no+'/'+row.pipe_no+'" title="Show">'+data+'</a>';
    //             },
    //             "targets": 2,
    //         },
    //         {render: function (data, type, row, meta) {
