...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        {{-- <div class="col-md-4">
            <div class="row">
                <div class="col-12">
                    @include('farmer_detail_extends.current_status')
                </div>
                ...
                <div class="card" style="margin-right: -24px;margin-left: -24px;">
                    <div class="card-body" style="padding-left: 23px;padding-top: 11px;padding-right: 2px;">
                      ...
                      <div class="mb-1">
                          ...
                          <div class="row">
                                  <a style="width: 30%;" href="{{url('l2/plot/edit/'.$plot->id.'/'.$plot->farmer_plot_uniqueid)}}"
                                    class="btn btn-info m-b-0 mr-3 EditBtn none"
