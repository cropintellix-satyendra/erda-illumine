...
$(function(){
    ...
    var table=$('.data-table').DataTable({
        ...
        "columnDefs": [
            {render: function (data, type, row, meta) {
                        ...
                        return '<a class="btn '+status_color+'" href="{{ url('l2/all-farmer/show')}}/'+row.farmer.id+'/'+row.farmer.farmer_uniqueId+'" title="Show">'+row.farmer_uniqueId+'</a>';
                },
                "targets": 0,
            },
            {render: function (data, type, row, meta) {
                    ...
                    return '<a class="btn '+status_color+'" href="{{ url('l2/all-farmer/plot')}}/'+row.id+'" title="Show">'+data+'</a>';
                },
                "targets": 2,
            },
            {render: function (data, type, row, meta) {
    ...
    $('.card-filter select').on('change',function(){
      ...
      $('.download-excel').on('click',function(e){
              ...
              var status = '';
            {{--  var status = '{{$status}}'; --}}
              var parms=$.param(clean({start_date,end_date,state,district,taluka,panchayats,village,farmer_status,executive_onboarding,file,type,status}));
              // if(type=='' || type==null){
