        ...
        <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Farmer onboarding</h4>
                                        ...
                                        @foreach($plots_paginate as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($value->final_status == 'Approved')
                                                     <a class="btn text-success" href="{{ url('l2/approved/plot/detail')}}/{{$value->farmer_plot_uniqueid}}" title="Show"> {{ $value->plot_no }}</a>
                                                     @endif                                                   
                                                </td>
...
$(function(){
    ...
    //                     status_color='text-danger';
    //                 }
    //                 return '<a class="btn '+status_color+'" href="{{ url('l2/approved/cropdata/plot')}}/'+row.farmer_plot_uniqueid+'/'+row.plot_no+'" title="Show">'+data+'</a>';
    //             },
    //             "targets": 2,
    //         },
    //         {render: function (data, type, row, meta) {
      ...
      $('.download-excel').on('click',function(e){
          ...
          success: function(data) {
            ...
            //   document.getElementById("FarmerCount").innerHTML = data.farmercount;
              ...
              document.getElementById("RecordApproved").innerHTML = data.approved??'0';
