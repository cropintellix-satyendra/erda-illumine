        ...
        "columnDefs": [
            {render: function (data, type, row, meta) {
              ...
              @elseif(Auth::user()->hasRole('SuperAdmin'))
                    ...
                    return '<a class="btn '+status_color+'" href="{{ url('l2/pending/show')}}/'+row.id+'/'+row.farmer.farmer_uniqueId+'" title="Show">'+row.farmer_plot_uniqueid+'</a>';
              @endif
                },
                "targets": 0,
            },
            {render: function (data, type, row, meta) {
                    ...
                    return '<a class="btn '+status_color+'" href="{{ url('l2/pending/plot/detail')}}/'+row.id+'" title="Show">'+data+'</a>';
                },
                "targets": 2,
            },
            {render: function (data, type, row, meta) {
