                                        ...
                                        @foreach($plots_paginate as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($value->l2_status == 'Pending')
                                                     <a class="btn text-info" href="{{ url('l2/pending/benefit/plot')}}/{{$value->farmer_uniqueId}}" title="Show"> {{ $value->benefit }}</a>
                                                     @endif                                                   
                                                </td>
...
$(function(){
    ...
    //                     status_color='text-danger';
    //                 }
    //                 return '<a class="btn '+status_color+'" href="{{ url('l2/pending/benefit/plot')}}/'+row.farmer_uniqueId+'" title="Show">'+data+'</a>';
    //             },
    //             "targets": 2,
    //         },
    //         {render: function (data, type, row, meta) {
