...
<div class="container-fluid">
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
          ...
          @endphp
          @if($prev)
          <a style="color: red;" href="{{ url('l2/pending/benefit/plot').'/'.$prev->farmer_uniqueId}}" class="btn btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Previous</a>
          @endif
          @if($next)
          <a style="color: red;" href="{{ url('l2/pending/benefit/plot').'/'.$next->farmer_uniqueId}}" class="btn btn-sm">Next <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
          @endif
        </div>
    </div>
    <!-- row -->
                        ...
                        <div class="mb-1">
                            ...
                            <div class="row">
                              ...
                              <button style="width: 26%;"
                                  ...
                                  class="btn btn-success ApproveBtn m-b-0 mr-3 {{ $benefit_data_detail->l2_status == 'Approved' ? 'disabled' : ''}}" {{-- below code is to disable button if --}}
                                    >
                                    Approve
                              </button>
                              <!-- approve end -->
    ...
    //search
        $('input[name="search"]').typeahead({
            ...
            source:function (query, process) {
                return $.get('{!! url('l2/benefit/search/Pending') !!}', { query: query }, function (data) {
                    var matches = [];
