                                        ...
                                        @foreach($plots_paginate as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($value->l2_status == 'Approved')
                                                     <a class="btn text-success" href="{{ url('l2/approved/benefit/plot')}}/{{$value->farmer_uniqueId}}" title="Show"> {{ $value->benefit }}</a>
                                                     @endif                                                   
                                                </td>
                                                <td>{{ $value->date_survey }}</td>
                                                <td>{{ $value->farmerapproved->mobile }}</td>
                                                <td>{{ $value->farmerapproved->state }}</td>
                                                <td>{{ $value->farmerapproved->district }}</td>
                                                <td>{{ $value->farmerapproved->taluka }}</td>
                                                <td>{{ $value->farmerapproved->village }}</td>
                                                <td>
                                                    @if($value->l2_status == 'Approved')
...
$(function(){
    ...
    //                     status_color='text-danger';
    //                 }
    //                 return '<a class="btn '+status_color+'" href="{{ url('l2/approved/benefit/plot')}}/'+row.farmer_uniqueId+'" title="Show">'+data+'</a>';
    //             },
    //             "targets": 2,
    //         },
    //         {render: function (data, type, row, meta) {
      ...
      $('.download-excel').on('click',function(e){
          ...
          success: function(data) {
            //   document.getElementById("FarmerCount").innerHTML = data.farmercount;
              document.getElementById("PlotCount").innerHTML = data.farmercount;
