...
{{-- 
                    <div class="col-xl-6 col-xx-6 col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-header">
                            <h4>
                                Aeration Event 3 Data Chart
                            </h4> 
                            </div>
                            <div class="card-body">
                                <center>
                                    <div id="aeration3loader" class=""><img  style="margin-top:20%;" src="{{asset('images/loaderr.gif')}}" alt="" height="150px" width="150px"></div>
                                </center>
                                <div id="aeration3chart" style="height: 370px; width: 100%;"></div>
                            </div>
                        </div>
                    </div> --}}
...
{{-- 
                    ...
                    <div class="col-xl-6 col-xx-6 col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-header">
                            <h4>
                                Aeration Event 4 Data Chart
                            </h4> 
                            </div>
                            <div class="card-body">
                                <center>
                                    <div id="aeration4loader" class=""><img  style="margin-top:20%;" src="{{asset('images/loaderr.gif')}}" alt="" height="150px" width="150px"></div>
                                </center>
                                <div id="aeration4chart" style="height: 370px; width: 100%;"></div>
                            </div>
                        </div>
                    </div> --}}
...
function areation3(){
    $('#aeration3loader').removeClass('d-none');
       $.ajax({
        type:'get',
        url: "{{url('admin/aeration3/data/count')}}",
        dataType: 'Json',
        success: function(data) {
...
function areation4(){
    $('#aeration4loader').removeClass('d-none');
       $.ajax({
        type:'get',
        url: "{{url('admin/aeration4/data/count')}}",
        dataType: 'Json',
        success: function(data) {
