                                        ...
                                        @foreach($pagination as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($value->l2_status == 'Pending')
                                                     <a class="btn text-info" href="{{ url('')}}/{{$rolename}}/view/l2/pending/cropdata/plot/{{$value->farmer_plot_uniqueid}}/{{$value->plot_no}}" title="Show"> {{ $value->plot_no }}</a>
                                                     @endif                                                   
                                                </td>
...
$(function(){
    ...
    //                     status_color='text-danger';
    //                 }
    //                 return '<a class="btn '+status_color+'" href="{{ url("")}}/'+rolename+'/view/l2/pending/cropdata/plot/'+row.farmer_plot_uniqueid+'/'+row.plot_no+'" title="Show">'+data+'</a>';
    //             },
    //             "targets": 2,
    //         },
    //         {render: function (data, type, row, meta) {
    ...
    //   });
      ...
      $('.download-excel').on('click',function(e){
          ...
          success: function(data) {
            ...
            //   document.getElementById("PlotCount").innerHTML = data.farmer_count;
