                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tbody id="Basicform">
                                        ...
                                        <tr>
                                            <td>Farmer Name</td>
                                            <td><input type="text" class="form-control" name="farmer_name" style="" value="{{$plot->farmer->farmer_name}}" readonly></td>
                                        </tr>
                                        <tr>
                                            <td>Mobile Access</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Mobile</td>
                                            <td><input type="text" class="form-control" name="mobile" value="{{$plot->farmer->mobile}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" readonly maxlength="10"></td>
                                        </tr>
                                        <tr>
                                            <td>No. of plots</td>
                                            <td>{{$plot->farmer->no_of_plots}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tbody id="EditPlot">
                                        <tr>
                                            <td>No of Plots</td>
                                            <td colspan="3">{{$plot->farmer->no_of_plots}}</td>
                                            <td>Area of Plots</td>
                                            <td>{{$plot->farmer->total_plot_area}}</td>
                                        </tr>
                                    ...
                                    <tbody id="EditLocation">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!--<input type="text" name="state" data-plot="{{$plot->plot_no}}" style="background-color:#efeeee;" value="{{$plot->panchayat}}" readonly>-->
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Village</td>
                                            <td>
                                                ...
                                                <!--<input type="text" name="state" data-plot="{{$plot->plot_no}}" style="background-color:#efeeee;" value="{{$plot->village}}" readonly>-->
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Remarks</td>
                                        ...
                                        <tr>
                                            <td>Latitude</td>
                                            <td>{{$plot->farmer->latitude}}</td>
                                        </tr>
                                        <tr>
                                            <td>Logitude</td>
                                            <td>{{$plot->farmer->longitude}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Name</td>
                                            <td><a target="_blank" href="">{{$plot->farmer->surveyor_name}}</a></td>
                                        </tr>
                                        <tr>
                                            <td>Mobile No</td>
                                            <td>{{$plot->farmer->surveyor_mobile}}</td>
                                        </tr>
                                        <tr>
                                            <td>Date of Survey</td>
                                            <td>{{$plot->farmer->date_survey}}</td>
                                        </tr>
                                        <tr>
                                            <td>Time of Survey</td>
                                            <td>{{ $plot->farmer->time_survey }} </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="card" style="margin-right: -24px;margin-left: -24px;">
                        <div class="card-body" style="padding-left: 23px;padding-top: 11px;padding-right: 2px;">
                            ...
                            <div class="mb-1">
                                ...
                                <div class="row">
                                    <a style="width: 30%;" href="{{url('l2/pending/plot/detail').'/'.$plot->id}}" class="btn btn-info m-b-0 mr-3 EditBtn"
                                        >Show</a>
                                    <!-- end button end -->
                                    {{-- onclick="submitApprove('{{$plot->farmer_uniqueId}}')" --}}
                                    <button style="width: 26%;" data-toggle="modal" data-target="#ApproveModal" class="btn btn-success ApproveBtn m-b-0 mr-3 d-none" {{-- below code is to disable button if --}} @if(Auth::user()->hasRole('L-1-Validator'))
                                        disabled
                                        @endif
                                        @if($plot->farmer_status == 'Approved')

                                        @elseif($plot->farmer_status == 'Rejected')
