...
<div class="container-fluid">
  ...
  <div id="countBoxRow" class="row">
   <div class="col-md-6 col-sm-12">
        <div class="card mini-stat countBox countBox1" style="background-color: #450b5a !important;">
            <div class="card-body mini-stat-img">
                <div class="text-white">
                    <h2 class="mb-4s text-center t-font text-white" id="PlotCount">0</h2>
                    <h6 class="text-uppercase-mb-3 title-font font-size-16 text-white text-center">Total Plots</h6>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-sm-12">
        <div class="card mini-stat bg-info countBox">
            <div class="card-body mini-stat-img">
                <div class="text-white">
                    <h2 class="mb-4s text-center t-font text-white" id="RecordApproved">0</h2>
                    <h6 class="text-uppercase-mb-3 title-font font-size-16 text-white text-center">Approved Plots</h6>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-sm-12">
        <div class="card mini-stat bg-success countBox">
            <div class="card-body mini-stat-img">
                <div class="text-white">
                    <h2 class="mb-4s text-center t-font text-white" id="RecordPending">0</h2>
                    <h6 class="text-uppercase-mb-3 title-font font-size-16 text-white text-center">Pending Plots</h6>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-sm-12">
        <div class="card mini-stat bg-warning countBox">
            <div class="card-body mini-stat-img">
                <div class="text-white">
                    <h2 class="mb-4s text-center t-font text-white" id="RecordRejected">0</h2>
                    <h6 class="text-uppercase-mb-3 title-font font-size-16 text-white text-center">Rejected Plots</h6>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-sm-12">
        <div class="card mini-stat bg-success countBox">
            <div class="card-body mini-stat-img">
                <div class="text-white">
                    <h2 class="mb-4s text-center tot-font text-white" id="TotalArea">0</h2>
                    <h6 class="text-uppercase-mb-3 title-font tot-font text-white text-center" style="font-size: 12px;">Total Area in Acres<span style="font-size: 12px;">(Approved)</span></h6>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card mini-stat bg-info countBox">
            <div class="card-body mini-stat-img">
                <div class="text-white">
                    ...
                    <h6 class="text-uppercase-mb-3 title-font font-size-16 text-white text-center">Others</h6>
                </div>
            </div>
        </div>
    </div>
...
$(function(){
    ...
    $('.card-filter select').on('change',function(){
      ...
      $('.download-excel').on('click',function(e){
              ...
              var parms=$.param(clean({start_date,end_date,season,state,district,taluka,panchayats,village,farmer_status,executive_onboarding,file,type,status,from}));
              // if(type=='' || type==null){
