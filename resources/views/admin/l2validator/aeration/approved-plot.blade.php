                                        ...
                                        @foreach($pagination as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($value->l2_status == 'Approved')
                                                     <a class="btn text-success" href="{{ url('')}}/{{$rolename}}/view/l2/approved/aeration/plot/{{$value->farmer_plot_uniqueid}}/{{$value->aeration_no}}/{{$value->pipe_no}}" title="Show"> {{ $value->plot_no }}</a>
                                                     @endif                                                   
                                                </td>
                                                <td>{{ $value->pipe_no }}</td>
...
$(function(){
    ...
    //                     status_color='text-danger';
    //                 }
    //                 return '<a class="btn '+status_color+'" href="{{ url("")}}/'+rolename+'/view/l2/approved/aeration/plot/'+row.farmer_plot_uniqueid+'/'+row.aeration_no+'/'+row.pipe_no+'" title="Show">'+data+'</a>';
    //             },
    //             "targets": 2,
    //         },
    //         {render: function (data, type, row, meta) {
    ...
    //   });
      ...
      $('.download-excel').on('click',function(e){
          ...
          $.ajax({
          type:'get',
          url: "{{url('l2/fetch/appoved/aeration/counting')}}",
          dataType: 'Json',
          success: function(data) {
