                                        ...
                                        @foreach($pagination as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($value->l2_status == 'Rejected')
                                                     <a class="btn text-danger" href="{{ url('')}}/{{$rolename}}/view/l2/approved/cropdata/plot/{{$value->farmer_plot_uniqueid}}/{{$value->plot_no}}" title="Show"> {{ $value->plot_no }}</a>
                                                    @endif                                                   
                                                </td>
                                                <td>{{ $value->pipe_no }}</td>
...
$(function(){
    ...
    //                     status_color='text-danger';
    //                 }
    //                 return '<a class="btn '+status_color+'" href="{{ url("")}}/'+rolename+'/view/l2/rejected/aeration/plot/'+row.farmer_plot_uniqueid+'/'+row.aeration_no+'/'+row.pipe_no+'" title="Show">'+data+'</a>';
    //             },
    //             "targets": 2,
    //         },
    //         {render: function (data, type, row, meta) {
