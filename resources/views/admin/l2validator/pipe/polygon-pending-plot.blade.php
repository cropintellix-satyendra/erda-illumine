                                        ...
                                        @foreach($pagination as $key => $value)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($value->final_status == 'Pending')
                                                     <a class="btn text-info" href="{{ url('')}}/{{$rolename}}/view/l2/pending/pipe/polygon/plot/{{$value->farmer_plot_uniqueid}}" title="Show"> {{ $value->plot_no }}</a>
                                                     @endif                                                   
                                                </td>
...
$(function(){
    ...
    //                 //     status_color='text-danger';
    //                 // }
    //                 return '<a class="btn text-info" href="{{ url("")}}/'+rolename+'/view/l2/pending/pipe/polygon/plot/'+row.farmer_plot_uniqueid+'" title="Show">'+data+'</a>';
    //             },
    //             "targets": 2,
    //         },
    //         {render: function (data, type, row, meta) {
