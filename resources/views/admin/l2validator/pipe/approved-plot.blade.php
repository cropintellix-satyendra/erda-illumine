                                ...
                                @foreach($pagination as $key => $value)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($value->l2status == 'Approved')
                                                <a class="btn text-success" href="{{ url('')}}/{{$rolename}}/view/l2/approved/pipeinstallation/plot/{{$value->farmer_plot_uniqueid}}" title="Show"> {{ $value->plot_no }}</a>
                                            @endif
                                        </td>
                                        <td>{{ $value->area_acre_awd }}</td>
                                        <td>{{ $value->mobile }}</td>
                                        <td>{{ $value->state }}</td>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            @if($value->l2status == 'Pending')
                                                <span class="badge badge-info">Pending</span>
                                            @endif
                                            @if($value->l2status == 'Rejected')
...
$(function(){
    ...
    //         { "data": "area_acre_awd","name":"area_acre_awd"},
    ...
    //                     status_color='text-danger';
    //                 }
    //                 return '<a class="btn '+status_color+'" href="{{ url("")}}/'+rolename+'/view/l2/approved/pipeinstallation/plot/'+row.farmer_plot_uniqueid+'" title="Show">'+data+'</a>';
    //             },
    //             "targets": 2,
    //         },
    //         {render: function (data, type, row, meta) {
    ...
    //   });
      ...
      $('.download-excel').on('click',function(e){
          ...
          $.ajax({
          type:'get',
          url: "{{url('admin/fetch/pipe/counting')}}",
          dataType: 'Json',
          success: function(data) {
