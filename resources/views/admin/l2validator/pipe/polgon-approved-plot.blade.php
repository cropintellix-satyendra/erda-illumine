                ...
                <div class="dropdown ml-auto">
                    @can('Download Excel')
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item download-excel" data-type="PipeInstalltion" href="{{url('l1/pipeinstallation/download')}}">PipeInstallation</a>
                    </div>--}}
                    @endcan
                </div>
              </div>
                                        ...
                                        @foreach($plots_paginate as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($value->final_status == 'Approved')
                                                     <a class="btn text-success" href="{{ url('')}}/l2/approved/pipe/polygon/plot/{{$value->farmer_plot_uniqueid}}" title="Show"> {{ $value->plot_no }}</a>
                                                     @endif
                                                </td>
                                                ...
                                                <td>{{$value->farmerapproved->created_at}}</td>
                                                <td>
                                                    @if($value->final_status == 'Approved')
...
$(function(){
    ...
    //                     status_color='text-danger';
    //                 }
    //                 return '<a class="btn '+status_color+'" href="{{ url("")}}/l2/approved/pipe/polygon/plot/'+row.farmer_plot_uniqueid+'" title="Show">'+data+'</a>';
    //             },
    //             "targets": 2,
    //         },
    //         // {render: function (data, type, row, meta) {
    //         //         return row.plot_detail.area_acre_awd;
    //         //     },
    //         //     "targets": 3,
    //         // },
    //         {render: function (data, type, row, meta) {
    ...
    //   });
      ...
      $('.download-excel').on('click',function(e){
          ...
          $.ajax({
          type:'get',
          url: "{{url('admin/fetch/polygon/counting')}}",
          dataType: 'Json',
          success: function(data) {
