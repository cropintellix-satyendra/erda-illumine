                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($value->l2status == 'Pending')
                                                     <a class="btn text-info" href="{{ url('')}}/{{$rolename}}/view/l2/pending/pipeinstallation/plot/{{$value->farmer_plot_uniqueid}}" title="Show"> {{ $value->plot_no }}</a>
                                                     @endif                                                   
                                                </td>
...
$(function(){
    ...
    //                   }
    //                   return '<a class="text-info" title="Show">'+row.farmer_plot_uniqueid+'</a>';
    ...
    //                 //     status_color='text-danger';
    //                 // }
    //                 return '<a class="btn text-info" href="{{ url("")}}/'+rolename+'/view/l2/pending/pipeinstallation/plot/'+row.farmer_plot_uniqueid+'" title="Show">'+data+'</a>';
    //             },
    //             "targets": 2,
    //         },
    //         {render: function (data, type, row, meta) {
