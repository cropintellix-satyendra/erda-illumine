                                        ...
                                        @foreach($plots_paginate as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($value->final_status == 'Rejected')
                                                        <a class="btn text-danger" href="{{ url('')}}/l2/rejected/pipe/polygon/plot/{{$value->farmer_plot_uniqueid}}" title="Show"> {{ $value->plot_no }}</a>
                                                    @endif                                                   
                                                </td>
                                                ...
                                                <td>{{ $value->farmerapproved->village->created_at }}</td>
                                                <td>
...
$(function(){
    ...
    //                   }
    //                   return '<a class="text-info '+status_color+'" title="Show">'+row.farmer_plot_uniqueid+'</a>';
    ...
    //                     status_color='text-danger';
    //                 }
    //                 return '<a class="btn text-info '+status_color+'" href="{{ url('l2/rejected/pipe/polygon/plot')}}/'+row.farmer_plot_uniqueid+'" title="Show">'+data+'</a>';
    //             },
    //             "targets": 2,
    //         },
    //         {render: function (data, type, row, meta) {
