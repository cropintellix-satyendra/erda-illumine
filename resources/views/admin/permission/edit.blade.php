                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                            <form action="{{route('admin.permissions.update',$permissions->id)}}" method="post">
                              ...
                              <div class="row">
                                  <div class="col-md-6 col-xl-3 col-xxl-6 mb-3">
                                      ...
                                      <div class="input-group">
                                          <input type="text" class="form-control @error('permission') is-invalid @enderror" name="permission" value="{{ $permissions->name }}" id="permission" required>
                                            @error('permission')
                              ...
                              <div class="col-12">
                                <a href="{{route('admin.permissions.index')}}" class="btn btn-danger mb-2 float-right">Cancel</a>
