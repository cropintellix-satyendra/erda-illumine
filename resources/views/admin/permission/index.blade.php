                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="container" style="margin-top: 2px;">
                                  <div class="row">
                                    <div class="col">
                                        <h4 class="card-title" style="margin-top: 15px">Permission</h4>
                                    </div>
                                    <div class="col">
                                        <a href="{{route('admin.permissions.create')}}" class="btn light btn-info float-right">Add</a>
                                    </div>
                                  </div>
                                </div>
                            </div>
                                    ...
                                    <table id="example3" class="display userTable" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="permission{{$permission->id}}">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="{{Route('admin.permissions.edit',$permission->id)}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                        {{--<button class="btn btn-danger shadow btn-xs sharp delete-Permission" data-id="{{$permission->id}}"><i class="fa fa-trash"></i></button>--}}
                                                    </div>
                                                </td>
                                            </tr>
                                            @endforeach
