                  ...
                  <div class="col-12">
                      <div class="card">
                          ...
                          <div class="card-body form-validation">
                            <form class="form-valide" action="{{url('admin/app/keys/update')}}" method="post" enctype="multipart/form-data">
                              @csrf
                              <div class="row">
                                <div class="col-md-6 col-xl-3 col-xxl-6 mb-3 form-group">
                                    <label for="name">SMS AUTH KEY <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="{{$sms_key->value}}" name="sms_key" id="sms_key">
                                    </div>
                                </div>
