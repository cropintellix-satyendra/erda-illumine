                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Create Areation Duration</h4>
                        </div>
                    </div>
                  ...
                  <div class="col-12">
                      <div class="card">
                          ...
                          <div class="card-body form-validation">
                            <form class="form-valide" action="{{route('admin.areationdate.store')}}" method="post">
                              @csrf
                              @method('POST')
                              <div class="row">
                                <div class="col-md-6 col-xl-3 col-xxl-6 mb-3 form-group">
                                    <label for="year_1">Duration <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="aeration_duration" name="aeration_duration"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..?)\../g, '$1');"
                                        value="" required>
                                    </div>
                                </div>
