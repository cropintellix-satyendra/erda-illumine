                              ...
                              <div class="row">
                                  <div class="col-md-6 col-xl-3 col-xxl-6 mb-3 form-group">
                                      ...
                                      <div class="input-group">
                                          <input type="text" class="form-control" id="name" value="{{$season->name}}" name="name" id="name">
                                      </div>
                                  </div>
                                  <div class="col-md-6 col-xl-3 col-xxl-6 mb-3 form-group">
                                    <label for="month1">Month <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input type="month" class="form-control" id="month1" name="month1" value="{{$season->month_1}}"> 
                                    </div>
                                </div>
                                <div class="col-md-6 col-xl-3 col-xxl-6 mb-3 form-group">
                                    <label for="month2">Month <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input type="month" class="form-control" id="month2" name="month2" value="{{$season->month_2}}"> 
                                    </div>
                                </div>
                                @php
