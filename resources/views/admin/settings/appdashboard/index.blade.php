					...
					<div class="col-12">
                        <div class="card">
							...
							<div class="container" style="margin-top: 2px;">
							  <div class="row">
							    <div class="col">
							      <h4 class="card-title" style="margin-top: 15px">App settings</h4>
							    </div>
							    <div class="col">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            @foreach($app_dashboard as $setting)
                                            <tr id="{{$setting->id}}">
                                                ...
                                                <td>
                        						<div class="d-flex">
                        		<a href="{{url('admin/app/settings/edit/'.$setting->id)}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
