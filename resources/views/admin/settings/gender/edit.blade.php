                  ...
                  <div class="col-12">
                      <div class="card">
                          ...
                          <div class="card-body form-validation">
                            <form class="form-valide" action="{{route('admin.gender.update',$gender->id)}}" method="post">
                              @csrf
                              @method('PUT')
                              <div class="row">
                                  <div class="col-md-6 col-xl-3 col-xxl-6 mb-3 form-group">
                                      ...
                                      <div class="input-group">
                                          <input type="text" class="form-control" id="name" value="{{$gender->name}}" name="name" id="name">
                                      </div>
                                  </div>
                                  <div class="col-md-6 col-xl-3 col-xxl-6 mb-3">
                                      ...
                                      <div class="input-group">
                                            <select class="form-control" name="status" required>
                                                <option value="1" {{$gender->status==1 ? 'selected' : ''}}>Enable</option>
                                                <option value="0" {{$gender->status==0 ? 'selected' : ''}}>Disable</option>
                                            </select>
                                      </div>
                                  </div>
                              </div>
                              <div class="col-12">
                                  <a href="{!! route('admin.gender.index'); !!}" class="btn btn-danger mb-2 float-right">Cancel</a>
