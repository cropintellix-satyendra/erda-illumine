...
<div class="container-fluid">
    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  @method('POST')
                    ...
                    {{ $editing ? $Setting->terms_and_conditions : ''}}</textarea><br>
        ...
        <div class="col-xl-12 col-xxl-12" id="carbon_section">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Carbon Credit</h4>
                </div>
                <div class="card-body">
                <form class="" action="{{url('admin/carboncredit')}}" method="post">
                  @csrf
                  @method('POST')
                    <textarea class="summernote" id="carboncredit" name="carboncredit" rows="4" cols="50">
                    {{ $editing ? $Setting->carbon_credit : ''}}</textarea><br>
                    <button type="submit" class="btn btn-primary mb-2 mr-2 float-right">Submit</button>
                    </form>
                </div>
            </div>
