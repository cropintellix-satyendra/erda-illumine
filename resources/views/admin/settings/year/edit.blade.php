                  ...
                  <div class="col-12">
                      <div class="card">
                          ...
                          <div class="card-body form-validation">
                            <form class="form-valide" action="{{route('admin.year.update',$year->id)}}" method="post">
                              @csrf
                              @method('Put')
                              <div class="row">
                                <div class="col-md-6 col-xl-3 col-xxl-6 mb-3 form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="year_1" name="year_1"  maxlength="4" minlength="4" value="{{$year->year_1}}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-xl-3 col-xxl-6 mb-3 form-group">
                                    <label for="year_2">Year 2<span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="year_2" name="year_2"  maxlength="4" minlength="4" value="{{$year->year_2}}">
                                    </div>
                                </div>
