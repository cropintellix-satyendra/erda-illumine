                  ...
                  <div class="col-12">
                      <div class="card">
                          ...
                          <div class="card-body form-validation">
                            <form class="form-valide" action="{{route('admin.organization.update',$organization->id)}}" method="post">
                              @csrf
                              @method('PUT')
                              <div class="row">
                                  <div class="col-md-6 col-xl-3 col-xxl-6 mb-3 form-group">
                                      ...
                                      <div class="input-group">
                                          <input type="text" class="form-control" id="name" value="{{$organization->name}}" name="name" id="name">
                                      </div>
                                  </div>
                                    ...
                                    <div class="input-group">
                                          <select class="form-control select2" id="state_id" name="state_id" required>
                                            ...
                                            @foreach($States as $state)
                                                <option value="{{$state->id}}" {{ $organization ? $organization->state_id == $state->id ? 'selected' :'' : ''}}>{{$state->name}}</option>
                                            @endforeach
                                          </select>
                                    </div>
                                </div>
                                  <div class="col-md-6 col-xl-3 col-xxl-6 mb-3">
                                      ...
                                      <div class="input-group">
                                            <select class="form-control" name="status" required>
                                                <option value="1" {{$organization->status==1 ? 'selected' : ''}}>Enable</option>
                                                <option value="0" {{$organization->status==0 ? 'selected' : ''}}>Disable</option>
                                            </select>
                                      </div>
                                  </div>
                              </div>
