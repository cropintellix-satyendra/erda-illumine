                  ...
                  <div class="col-12">
                      <div class="card">
                          <div class="card-header">
                              <h4 class="card-title">Areation Date</h4>
                          </div>
                            ...
                            <form class="form-valide" action="{{route('admin.areationdate.update',$date->id)}}" method="post">
                              ...
                              <div class="row">
                                <div class="col-md-6 col-xl-3 col-xxl-6 mb-3 form-group">
                                    <label for="year_1">Date<span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input type="date" class="form-control" id="date" name="date" value="{{ \Carbon\Carbon::createFromFormat('d/m/Y', $date->date)->format('Y-m-d') }}">
                                    </div>
                                </div>
