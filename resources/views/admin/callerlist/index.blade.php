        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Callerlists</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="container" style="margin-top: 2px;">
                            <div class="row">
                                <div class="col">
                                    <h4 class="card-title" style="margin-top: 15px">Caller Lists</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($callers as $caller)
                                        <tr id="{{ $caller->id }}">
                                            ...
                                            <td>{{ $caller->called_number }}</td>
                                            <td>{{ $caller->phoneno_zone }}</td>
                                            <td>{{ $caller->operator }}</td>
                                            <td>{{ $caller->call_time }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
