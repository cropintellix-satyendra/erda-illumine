                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>State</td><td>{{$farmer_details->state ?? 'N/A'}}</td>
                                            <td>Districts</td><td>{{$farmer_details->district ?? 'N/A'}}</td>

                                        </tr>
                                        <tr>
                                            <td>Taluka</td><td>{{$farmer_details->taluka ?? 'N/A'}}</td>
                                            <td>Age</td><td>{{$farmer_details->taluka ?? 'N/A'}}</td>

                                        </tr>
                                        <tr>
                                            <td>Panchayat</td><td>{{$farmer_details->panchayat ?? 'N/A'}}</td>
                                            <td>Village</td><td>{{$farmer_details->village ?? 'N/A'}}</td>
