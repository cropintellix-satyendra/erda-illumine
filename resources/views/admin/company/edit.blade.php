                            ...
                            <form action="{{route('admin.company.update',$user->id)}}" method="post">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6 col-xl-3 col-xxl-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="company_code" value="{{$company->company_code}}" id="name" required maxlength="6" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" 
                                        readonly>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xl-3 col-xxl-6 mb-3">
