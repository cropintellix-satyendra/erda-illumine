                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>L-1 Validator Create</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Admin</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Create L-1 Validator</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                <div class="row">
                  <div class="col-12">
                      <div class="card">
                          ...
                          <div class="card-body">
                            <form action="{{route('admin.validator.store')}}" method="post">
                              @csrf
                              @method('POST')
                              <div class="row">
                                  ...
                                  <div class="col-md-6 col-xl-3 col-xxl-6 mb-3">
                                   ...
                                   <div class="col-md-6 col-xl-3 col-xxl-6 mb-3">
                                    ...
                                    <div class="input-group">
                                          <select class="form-control select2 @error('roles') is-invalid @enderror" id="roles" name="roles" required>
                                              <option value="">Select Role</option>
                                                @foreach($roles as $role)
                                                    <option id="role{{$role->id}}" value="{{$role->id}}" data-rolename="{{$role->name}}">{{$role->name}}</option>
                                                @endforeach
                                          </select>
                                        @error('roles')
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-6 col-xl-3 col-xxl-6 mb-3 blockdiv">
                                  ...
                                  {{-- <div class="col-md-6 col-xl-3 col-xxl-6 mb-3">
                                      ...
                                      <div class="input-group">
                                            <select class="form-control select2" multiple onchange="FetchVillage(this.value)"  id="panchayat_id" name="panchayat[]" >
                                  ...
                                  <div class="col-md-6 col-xl-3 col-xxl-6 mb-3">
                                      ...
                                      <div class="input-group">
                                            <select class="form-control select2" multiple id="village_id" name="village[]" >
