            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{-- {{dd($plot->where('))}} --}}
                            @php
                                $farmer_image = App\Models\FinalFarmer::where('farmer_uniqueId',$plot->farmer_uniqueId)->where('plot_no',1)->get();
                                // dd($farmer_image);
                            @endphp
                              ...
                              <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                 ...
                                 @if($items->farmer_photo != NULL){
                                     <div class="carousel-item active">
                                       <img class="d-block w-100" height="350" src="{{$items->farmer_photo??NULL}}" alt="">
                                     </div>
                                 }

                                 @elseif($items->aadhaar_photo != NULL){
                                     <div class="carousel-item">
                                       <img class="d-block w-100" height="350" src="{{$items->aadhaar_photo??NULL}}" alt="">
                                     </div>
                                 }

                                 @elseif($items->others_photo != NULL){
                                     <div class="carousel-item">
                                       <img class="d-block w-100" height="350" src="{{$items->others_photo??NULL}}" alt="">
                                     </div>
                                 }
                                 @endif
                                  </div>
               ...
               {{-- {{dd($plot->plot_no)}}  --}}
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title bg-primary text-white p-3 text-center">Consent Form photos</h5>
                          
                            {{-- {{dd($plot->where('))}} --}}
                            @php
                                $farmer_image = App\Models\FarmerConsentForm::where('farmer_uniqueId',$plot->farmer_uniqueId)->where('plot_no',1)->get();
                                // dd($farmer_image);
                            @endphp
                              @foreach($farmer_image as $items)
                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                      ...
                                      <div class="carousel-item active">
                                        <img class="d-block w-100" height="350" src="{{$items->images}}" alt="consent_form_images">
                                      </div>
                                    </div>
                                    <a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev">
                                      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
