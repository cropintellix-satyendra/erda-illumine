                                ...
                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                      ...
                                      <div class="carousel-item active">
                                        <img class="d-block w-100" height="350" src="{{$items->farmer_photo}}" alt="">
                                      </div>
                                      <div class="carousel-item">
                                        <img class="d-block w-100" height="350" src="{{$items->aadhaar_photo}}" alt="">
                                      </div>
                                      <div class="carousel-item">
                                        <img class="d-block w-100" height="350" src="{{$items->others_photo}}" alt="">
                                      </div>
                                    </div>
