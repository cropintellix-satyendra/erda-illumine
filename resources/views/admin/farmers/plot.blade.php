...
$(function(){
        ...
        "columnDefs": [
            ...
            {render: function (data, type, row, meta) {
                ...
                @else
                    ...
                    return '<a class="btn '+status_color+'" href="{{ url('admin/farmer/plot')}}/'+row.id+'" title="Show">'+data+'</a>';
                @endif
                },
                "targets": 2,
            },
    ...
    $('.card-filter select').on('change',function(){
      ...
      $('.download-excel').on('click',function(e){
              ...
              var parms=$.param(clean({start_date,end_date,season,state,district,taluka,panchayats,village,farmer_status,executive_onboarding,file,type,status,userid,rolename,l1_validator}));
              // if(type=='' || type==null){
