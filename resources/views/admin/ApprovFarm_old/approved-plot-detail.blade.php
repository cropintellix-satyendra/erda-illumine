...
<div class="container-fluid">
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
          @php
              $prev=\App\Models\FinalFarmer::select('id','farmer_plot_uniqueid')->where('final_status_onboarding','Approved')->where('id','<',$plot->id)->orderBy('id','desc')->when(request(),function($q){

              return $q;
              })->first()??'';
              $next=\App\Models\FinalFarmer::select('id','farmer_plot_uniqueid')->where('final_status_onboarding','Approved')->where('id','>',$plot->id)->orderBy('id','asc')->when(request(),function($q){
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="">
                                        <ul class="nav nav-pills" style="display: flex; align-items: center;">
                                            ...
                                            <li class="nav-item">
                                                <a href="#plot-{{$Croplotbtn->plot_no}}" class="nav-link" data-toggle="tab" aria-expanded="false">Plot {{$Croplotbtn->plot_no}}</a>
                                            </li>
                                            &nbsp;
                                            @endforeach
                                        </ul>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="plot-{{$Croplot->plot_no}}" class="tab-pane pt-2">
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-sm">
                                                <tbody>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>Patta Number</td>
                                                        <td>{{$plot->patta_number}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Daag Number</td>
                                                        <td>{{$plot->daag_number}}</td>
                                                    </tr>
                                                    @endif
                                                    @if ($farmer->state_id == 37)
                                                    <tr>
                                                        <td>Khatian Number</td>
                                                        <td>{{$plot->khatian_number}}</td>
                                                    </tr>
                                                    @endif
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer p-0">
                                <div class="row">
                                    ...
                                    @can('Download Excel')
                                    <div class="col-6">
                                        <a class="btn text-success btn-sm" href="{{url('admin/l2/download/file/'.'Individuals/'.$plot->farmer_uniqueId.'/'.$plot->plot_no.'/'.'Approved')}}"><i class="fa fa-download" aria-hidden="true"></i> Download Excel</a>
                                    </div>
                                    @endcan
                                </div>
                            </div>
                      ...
                      <div class="card-body" style="padding-left: 23px;padding-top: 11px;padding-right: 2px;">
                        ...
                        <div class="mb-1">
                            <div class="row mb-3">
                              ...
                              <a style="width: 31%;" href="{{url('admin/approved/pipeinstallation/plot/'.$plot->farmer_plot_uniqueid)}}" target="_blank" class="btn btn-status{{$check_pipedata ? '-done' : ' disabled'}} m-b-0 mr-3"><span class="btn-txt">Pipes Installations</span></a>
                            </div>
                            <div class="row mb-3">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-sm">
                                            <tbody>
                                                ...
                                                <tr><td>Crop Season</td><td>{{$Croplot->season}}</td></tr>
                                                <tr><td>Crop Variety</td><td>{{$Croplot->crop_variety}}</td></tr>
  ...
  @include('admin.farmers.timeline')
</div>
