                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-sm">
                                        ...
                                        <tbody id="Basicform">
                                            ...
                                            <tr>
                                              <td>Farmer Name</td><td><input type="text" class="form-control farmer_name" name="farmer_name" style="" value="{{$plot->farmer_name}}" readonly>
                                            ...
                                            <tr>
                                              <td>Mobile</td><td><input type="text" class="form-control mobile"  name="mobile" value="{{$plot->mobile}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" readonly maxlength="10">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-sm">
                                        ...
                                        <tbody id="EditPlot">
                                          <tr>
                                            <td>No of Plots</td><td colspan="3">{{$plot->no_of_plots}}</td><td>Area of Plots</td><td>{{$plot->total_plot_area}}</td>
                                          </tr>
                                    ...
                                    <table class="table table-bordered table-sm">
                                        ...
                                        <tbody id="EditLocation">
                                            <tr>
                                              ...
                                              <!--    <option value="{!! $state->id !!}" {{ $plot->state_id == $state->id ?'Selected' :'' }}>{!! $state->name !!}</option>-->
                                              <!--    @endforeach-->
                                              <!--    @endif-->
                                              <!--</select>-->
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                  ...
                                                  <!--    <option value="{!! $district->id !!}" {{ $plot->district_id == $district->id ?'Selected' :'' }}>{!! $district->district !!}</option>-->
                                                  <!--    @endforeach-->
                                                  <!--    @endif-->
                                                  <!--</select>-->
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                  ...
                                                  <!--    <option value="{!! $taluka->id !!}" {{ $plot->taluka_id == $taluka->id ?'Selected' :'' }}>{!! $taluka->taluka !!}</option>-->
                                                  <!--    @endforeach-->
                                                  <!--    @endif-->
                                                  <!--</select>-->
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                  <select id="panchayats" name="panchayats" {{--onchange="FetchVillage(this.value)"--}} class="form-control select2" disabled>
                                                      ...
                                                      <option value="{!! $panchayat->id !!}" {{ $plot->panchayat_id == $panchayat->id ?'Selected' :'' }}>{!! $panchayat->panchayat !!}</option>
                                                      @endforeach
                                                      @endif
                                                  </select>
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                  <select id="villages" name="villages" class="form-control select2" disabled>
                                                      ...
                                                      <option value="{!! $village->id !!}" {{ $plot->village_id == $village->id ?'Selected' :'' }}>{!! $village->village !!}</option>
                                                      @endforeach
                                                      @endif
                                                  </select>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-sm">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Name</td><td><a  target="_blank"  href="{{Route('admin.users.edit',$plot->surveyor_id)}}">{{$plot->surveyor_name}}</a></td>
                                            </tr>
                                            <tr>
                  ...
                  <div class="card" style="margin-right: -24px;margin-left: -24px;">
                      <div class="card-body" style="padding-left: 23px;padding-top: 11px;padding-right: 2px;">
                        ...
                        <div class="mb-1">
                            ...
                            <div class="row">
                                    <a style="width: 30%;" href="{{url('admin/farmer/approved/plot').'/'.$plot->farmer_plot_uniqueid}}"
                        ...
                        <div class="card-body">
                            ...
                            <div id="PlotImg" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    @foreach($plot->ApprvFarmerPlotImages as $items)
                ...
                <div class="container">
                  ...
                  <div class="row">
                    <div class="col mt-2">
                      ...
                      name="onboarding" value="{{$plotlist->plot_no}}" {{$plotlist->status_onboarding == 'Approved' ?' ':''}}>
...
$('.UpdateBasicform').click(function(){
    ...
    $.ajax({
      type:'post',
      url:"{{url('admin/farmers/approved/update/')}}/"+'{{$plot->id}}',
...
$('.UpdatePlot').click(function(){
    ...
    $.ajax({
      type:'post',
      url:"{{url('admin/farmers/approved/update/')}}/"+'{{$plot->id}}',
      data: {_token:'{{csrf_token()}}',method:'post',area:area,ownername:ownername,survey:survey,unique:'{{$plot->farmer_uniqueId}}',type:'UpdatePlot'},
      success:function(data){
