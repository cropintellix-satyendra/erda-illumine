...
<div class="container-fluid">
    <div class="row page-titles mx-0">
        ...
        $prev=\App\Models\FarmerPlot::with('farmer')->where('farmer_uniqueId','<',$Farmer->farmer_uniqueId)->where('status','Approved')->orderBy('id','desc')->whereHas('farmer',function($q){
                $q->where('onboarding_form','1');
              return $q;
            })->first();

            $next=\App\Models\FarmerPlot::with('farmer')->where('farmer_uniqueId','>',$Farmer->farmer_uniqueId)->where('status','Approved')->orderBy('id','asc')->whereHas('farmer',function($q){
                $q->where('onboarding_form','1');
              return $q;
            })->first();
