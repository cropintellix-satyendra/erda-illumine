...
<div class="container-fluid">
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            ...
            @endphp
            @if($prev)
            <a style="color: red;" href="{{ url('l1/reject/show',[$prev->id,$prev->farmer_uniqueId])}}" class="btn btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Previous</a>
            @endif
            @if($next)
            <a style="color: red;" href="{{ url('l1/reject/show',[$next->id,$next->farmer_uniqueId])}}" class="btn btn-sm">Next <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
            @endif
        </div>
    </div>
    <!-- row -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer p-0">
                            <div class="row">
                                ...
                                @can('Download Excel')
                                <div class="col-6">
                                    <a class="btn text-success btn-sm" href="{{url('l1/download/file'.'/?type=onboarding&file=excel&unique='.$plot->farmer_uniqueId)}}"><i class="fa fa-download" aria-hidden="true"></i> Download Excel</a>
                                </div>
                                @endif
                            </div>
                        </div>
                  ...
                  <div class="card" style="margin-right: -24px;margin-left: -24px;">
                      <div class="card-body" style="padding-left: 23px;padding-top: 11px;padding-right: 2px;">
                        ...
                        <div class="mb-1">
                            ...
                            <div class="row">
                                    <a style="width: 30%;" href="{{url('l1/show/edit/'.$Farmer->id.'/'.$Farmer->farmer_uniqueId)}}"
                              ...
                              <button style="width: 26%;"
                                  ...
                                  class="btn btn-success ApproveBtn m-b-0 mr-3" Disabled
...
$(".SubmitApproval").click(function() {
    ...
    Swal.fire({
		  ...
		  if (result.value == 1) {
                ...
                $.ajax({
                  type:'post',
                  url:"{{url('l1/status/')}}/"+'onboarding/{{$Farmer->farmer_uniqueId}}',
    ...
    $('.Req'+plotno).addClass('d-none');
        Swal.fire({
		  ...
		  if (result.value == 1) {
                ...
                $.ajax({
                  type:'post',
                  url:"{{url('l1/status/')}}/"+'reject'+'/'+'{{$Farmer->farmer_uniqueId}}',
