    ...
    var table=$('.data-table').DataTable({
        ...
        "columnDefs": [
            {render: function (data, type, row, meta) {
                      ...
                      return '<a class="text-danger" title="Show">'+row.farmer_plot_uniqueid+'</a>';
            ...
            {render: function (data, type, row, meta) {
                    ...
                    return '<a class="btn text-danger" href="{{ url('l1/rejected/pipeinstallation/plot')}}/'+row.farmer_plot_uniqueid+'" title="Show">'+data+'</a>';
                },
                "targets": 2,
            },
            {render: function (data, type, row, meta) {
