        ...
        "columnDefs": [
            {render: function (data, type, row, meta) {
                     @if(Auth::user()->hasRole('L-1-Validator'))
                       ...
                       return '<a class="'+status_color+'">'+row.farmer_uniqueId+'</a>';
                     @elseif(Auth::user()->hasRole('SuperAdmin'))
                       ...
                       return '<a class="btn '+status_color+'" href="{{ url('l1/approved/show')}}/'+row.id+'/'+row.farmer.farmer_uniqueId+'" title="Show">'+row.farmer_uniqueId+'</a>';
                     @endif
                },
                "targets": 0,
            },
            {render: function (data, type, row, meta) {
                    ...
                    return '<a class="btn '+status_color+'" href="{{ url('l1/approved/plot/detail')}}/'+row.id+'" title="Show">'+data+'</a>';
                },
                "targets": 2,
            },
            {render: function (data, type, row, meta) {
