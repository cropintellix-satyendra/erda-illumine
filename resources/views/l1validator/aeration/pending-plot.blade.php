                    ...
                    <div class=" bg-success countBox">
                        <div class="card-body mini-stat-img boxm">
                            <div class="text-white">
                                ...
                                <h6 class="text-uppercase-mb-3 t-font font-size-16 text-white text-center">Approved Plot
                                </h6>
                            </div>
                        </div>
                    </div>
    ...
    var table=$('.data-table').DataTable({
        ...
        "columnDefs": [
            ...
            {render: function (data, type, row, meta) {
                    ...
                    return '<a class="btn '+status_color+'" href="{{ url('l1/pending/aeration/plot/')}}/'+row.farmer_plot_uniqueid+'/'+row.aeration_no+'/'+row.pipe_no+'" title="Show">'+data+'</a>';
                },
                "targets": 2,
            },
            {render: function (data, type, row, meta) {
