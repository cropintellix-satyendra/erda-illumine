                    ...
                    <div class=" bg-info countBox">
                        <div class="card-body mini-stat-img boxm">
                            <div class="text-white">
                                ...
                                <h6 class="text-uppercase-mb-3 t-font font-size-16 text-white text-center">Totalaa Plot
                                </h6>
                            </div>
                        </div>
                    </div>
                ...
                <div class="dropdown ml-auto">
                    @can('Download Excel')
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item download-excel" data-type="Aeration" href="{{url('l1/aeration/download')}}">Aeration</a>
                        </div>
                    @endcan                  
                </div>
              </div>
    ...
    var table=$('.data-table').DataTable({
        ...
        "columnDefs": [
            ...
            {render: function (data, type, row, meta) {
                    ...
                    return '<a class="btn '+status_color+'" href="{{ url('l1/approved/aeration/plot')}}/'+row.farmer_plot_uniqueid+'/'+row.aeration_no+'/'+row.pipe_no+'" title="Show">'+data+'</a>';
                },
                "targets": 2,
            },
            {render: function (data, type, row, meta) {
