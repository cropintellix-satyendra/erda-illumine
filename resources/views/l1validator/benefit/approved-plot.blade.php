                ...
                <div class="dropdown ml-auto">
                    @can('Download Excel')
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item download-excel" data-type="BenefitData" href="{{url('l1/benefit/download')}}">Cropdata</a>
                        </div>
                    @endcan                  
                </div>
              </div>
    ...
    var table=$('.data-table').DataTable({
        ...
        "columnDefs": [
            ...
            {render: function (data, type, row, meta) {
                    ...
                    return '<a class="btn '+status_color+'" href="{{ url('l1/approved/benefit/plot')}}/'+row.farmer_uniqueId+'" title="Show">'+data+'</a>';
                },
                "targets": 2,
            },
            {render: function (data, type, row, meta) {
