        ...
        "columnDefs": [
            {render: function (data, type, row, meta) {
                  ...
                  @elseif(Auth::user()->hasRole('SuperAdmin'))
                    ...
                    return '<a class="btn '+status_color+'" href="{{ url('l1/reject/show')}}/'+row.id+'/'+row.farmer.farmer_uniqueId+'" title="Show">'+row.farmer_uniqueId+'</a>';
                  @endif
                },
                "targets": 0,
            },
            {render: function (data, type, row, meta) {
                    ...
                    return '<a class="btn '+status_color+'" href="{{ url('l1/reject/plot/detail')}}/'+row.id+'" title="Show">'+data+'</a>';
                },
                "targets": 2,
            },
            {render: function (data, type, row, meta) {
