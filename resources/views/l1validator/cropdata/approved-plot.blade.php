                ...
                <div class="dropdown ml-auto">
                    @can('Download Excel')
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item download-excel" data-type="CropData" href="{{url('l1/cropdata/download')}}">Cropdata</a>
                        </div>
                    @endcan                  
                </div>
              </div>
    ...
    var table=$('.data-table').DataTable({
        ...
        "columnDefs": [
            ...
            {render: function (data, type, row, meta) {
                    ...
                    return '<a class="btn '+status_color+'" href="{{ url('l1/approved/cropdata/plot')}}/'+row.farmer_plot_uniqueid+'/'+row.plot_no+'" title="Show">'+data+'</a>';
                },
                "targets": 2,
            },
            {render: function (data, type, row, meta) {
