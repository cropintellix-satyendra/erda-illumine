                ...
                <div class="dropdown ml-auto">
                    @can('Download Excel')
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item download-excel" data-type="onboarding" href="{{url('l1/download/file')}}">Farmer onboarding</a>
                    </div>
                    @endcan                 
                </div>
              </div>
        ...
        "columnDefs": [
            {render: function (data, type, row, meta) {
                  ...
                  @elseif(Auth::user()->hasRole('SuperAdmin'))
                    ...
                    return '<a class="btn '+status_color+'" href="{{ url('l1/pending/show')}}/'+row.id+'/'+row.farmer.farmer_uniqueId+'" title="Show">'+row.farmer_uniqueId+'</a>';
                  @endif
            ...
            {render: function (data, type, row, meta) {
                    ...
                    return '<a class="btn '+status_color+'" href="{{ url('l1/pending/plot/detail')}}/'+row.id+'" title="Show">'+data+'</a>';
                },
                "targets": 2,
            },
            {render: function (data, type, row, meta) {
