...
<body>
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{!! url('organization/dashboard'); !!}" class="brand-logo">
                <img class="logo-abbr biglogo d-md-block" style="max-width: 182px;" src="{{ asset('images/kosher.jpeg') }}" alt="logo">
        ...
        ***********************************-->
		...
		@include('organization.layout.elements.header')
        ...
        ***********************************-->
        ...
        <!--**********************************
            Sidebar start
        ***********************************-->
        @include('organization.layout.elements.sidebar')
        <!--**********************************
            Sidebar end
        ***********************************-->
        ...
        ***********************************-->
		...
		@include('organization.layout.elements.footer')
    ...
    ***********************************-->
    ...
    <!--**********************************
        Scripts
    ***********************************-->
	@include('organization.layout.elements.footer-scripts')
  @yield('scripts')
