                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
									<div class="header-info">
										...
										<small>@if(auth()->user()->hasRole('SuperAdmin')) ADMIN @elseif(auth()->user()->hasRole('L-1-Validator')) L-1-Validator
											 				@elseif(auth()->user()->hasRole('Viewer')) VIEWER
											 				@elseif(auth()->user()->hasRole('SuperValidator')) SUPERVALIDATOR
                              @elseif(auth()->user()->hasRole('L-2-Validator')) L-2-Validator
															@endif </small>
