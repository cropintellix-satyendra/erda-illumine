                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">
                                <!-- here can be any text if you want to display on header -->
                            </div>
                        </div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
									<div class="header-info">
										...
										<small><?php if(auth()->user()->hasRole('SuperAdmin')): ?> ADMIN <?php elseif(auth()->user()->hasRole('L-1-Validator')): ?> L-1-Validator
											 				<?php elseif(auth()->user()->hasRole('Viewer')): ?> VIEWER
											 				<?php elseif(auth()->user()->hasRole('SuperValidator')): ?> SUPERVALIDATOR
                              <?php elseif(auth()->user()->hasRole('L-2-Validator')): ?> L-2-Validator
															<?php endif; ?> </small>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="<?php echo e(url('admin/profile')); ?>" class="dropdown-item ai-icon">
                                        <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                        <span class="ml-2">Profile </span>
                                    </a>
                                    <a href="<?php echo url('admin/logout'); ?>" class="dropdown-item ai-icon">
...
<?php /**PATH C:\xampp\htdocs\erda-illumine\resources\views/elements/header.blade.php ENDPATH**/ ?>