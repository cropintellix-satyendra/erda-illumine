...
class L2PolygonExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithEvents,WithStyles,WithChunkReading
{
    ...
    */
    ...
    public function map($farmer): array{
      $payload_fields = [ 
        ...
        $farmer->date_survey??"_",
        $farmer->date_time??"_",
        $farmer->surveyor_name??"_",
        $farmer->FormSubmitBy->mobile??"_",
        $farmer->status??"_",
