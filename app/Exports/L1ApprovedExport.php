...
class L1ApprovedExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithEvents,WithStyles,WithChunkReading,ShouldQueue
{
    use Exportable;
    ...
    */
    public function collection()
    {
        ...
        $farmer = FarmerPlot::where('status','Approved')->whereHas('farmer', function($q) use($request) {
