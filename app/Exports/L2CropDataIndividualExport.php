...
class L2CropDataIndividualExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithEvents,WithStyles,WithChunkReading,ShouldQueue
{
    use Exportable;
    ...
    */
    ...
    public function map($farmer): array{
        ...
        array_push($payload_fields,  $farmer->l2_status,$validator->ValidatorUserDetail->name??"-");
    ...
    public function headings(): array{
        ...
        'CROPDATA','Plot Unique ID', 'Plot No', 'Area of plots', 'Seasons', 'Crop Variety','Lastirrigation date', 'Date of Ploughing', 'Date of Transplanting',
                  'landOwnership', 'Date', 'Time','Survey No','Surveyor Name', 'Surveyor Email','Surveyor Mobile','l2_status','l2_validator','Area In Bigha',
