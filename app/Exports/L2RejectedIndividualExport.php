...
class L2RejectedIndividualExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithEvents,WithStyles,WithChunkReading
{
    ...
    */
    public function collection()
    {
        ...
        // $farmer = FarmerPlot::where('status','Rejected')->where('final_status','Rejected')->where('finalreject_userid',$request->userid)->whereHas('farmer', function($q) use($request) {
        //                                 return $q;
        //                                 })
        //                       ->with('farmer')->get();
