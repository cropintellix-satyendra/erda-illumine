...
class L1PendingExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithEvents,WithStyles,WithChunkReading,ShouldQueue
{
    use Exportable;
    ...
    */
    public function collection()
    {
        ...
        $farmer = FarmerPlot::where('status','Pending')->whereHas('farmer', function($q) use($request) {
