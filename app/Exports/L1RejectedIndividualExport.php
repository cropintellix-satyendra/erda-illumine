...
class L1RejectedIndividualExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithEvents,WithStyles,WithChunkReading,ShouldQueue
{
    use Exportable;
    ...
    */
    public function collection()
    {
        ...
        // $farmer = FarmerPlot::where('status','Rejected')->where('aprv_recj_userid',$request->userid)->whereHas('farmer', function($q) use($request) {
        //                                 return $q;
        //                                 })
        //                       ->with('farmer')->take(100)->get();
