...
class AdminL2RejectExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithEvents,WithStyles,WithChunkReading
{
    ...
    */
    public function collection()
    {
        ...
        $farmer = FarmerPlot::where('status','Rejected')->where('final_status','Rejected')->whereHas('farmer', function($q) use($request) {
