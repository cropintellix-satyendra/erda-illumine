...
class L2PendingIndividualExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithEvents,WithStyles,WithChunkReading
{
    ...
    public function headings(): array{
      ...
      $header = ['Farmer UniqueID', 'Farmer Name', 'Mobile Access', 'Mobile Relation Owner', 'Mobile', 'No. of PLots','Total Plot Area (Acres)','Country',
                 ...
                 'PlotData','Plot Images', 'Plot Unique ID', 'Plot No'];
                     ...
                     if($state_id->state_id == 29){
                        array_push($header,'Area in Acers','Land Ownership','Actual Owner Name','Survey No','L1 PlotStatus','L1 Plotstatus update Date','L1 Plotstatus update Time','L1 Final Validator Name','Surveyor Name', 'Surveyor Mobile');
                     }else{
                        array_push($header,'Area in (A.G)','Area in Acres','Land Ownership','Actual Owner Name','Survey No','L1 PlotStatus','L1 Plotstatus update Date','L1 Plotstatus update Time','L1 Final Validator Name','Surveyor Name', 'Surveyor Mobile');
                     }
