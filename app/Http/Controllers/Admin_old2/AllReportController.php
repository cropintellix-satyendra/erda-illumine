...
class AllReportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('report',compact('page_title','action','page_title','page_description','states','districts','talukas','panchayats','villages','onboarding_executive','l1_validators','l2_validators'));
    }
