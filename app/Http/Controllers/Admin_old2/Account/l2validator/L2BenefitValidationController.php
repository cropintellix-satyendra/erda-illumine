...
class L2BenefitValidationController extends Controller
{
  ...
  public function benefit_pending_lists()
  {
	...
	//   if(request()->ajax()){
        ...
        $paginatedbenefit_data = array_slice($benefit_data, $start, $perPage);

        $pagination = new LengthAwarePaginator(
            $paginatedbenefit_data,
            count($benefit_data),
            $perPage,
            $page,
	...
	//   }//end layoutout plot WITH AJAX
      ...
      $others = "0";
  	  return view('admin.l2validator.benefit.pending-plot',compact('links','pagination','page_title','page_description','action','seasons','states', 'districts','talukas','panchayats','villages','onboarding_executive','status','others'));
  }
  ...
  public function benefit_approved_lists()
  {
	...
	//   }//end layoutout plot WITH AJAX
      ...
      $status = request()->status;
      $others = "0";
  	  return view('admin.l2validator.benefit.approved-plot',compact('links','pagination','page_title','page_description','action','seasons','states', 'districts','talukas','panchayats','villages','onboarding_executive','status','others'));
  }
